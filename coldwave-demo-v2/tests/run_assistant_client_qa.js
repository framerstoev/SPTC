...
const sourcePaths = {
  "../js/assistant-config.js": path.join(v2Root, "js", "assistant-config.js"),
  "../js/assistant-api.js": path.join(v2Root, "js", "assistant-api.js")
};
...
globalThis.location = {
  href: "http://127.0.0.1:8001/coldwave-demo-v2/tests/assistant-client-tests.html"
